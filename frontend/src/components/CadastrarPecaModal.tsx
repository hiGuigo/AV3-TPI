...
import { useCadastrarPeca } from "../hooks/peca/useCadastrarPeca";
...
export function CadastrarPecaModal({
  isOpen,
  aeronaveId,
  onClose,
  onSuccess,
  ...
  const { formData, errors, isSubmitting, handleChange, handleSubmit } =
    useCadastrarPeca(aeronaveId, onSuccess);
      ...
      <div className="bg-white rounded-xl p-6 w-full max-w-lg shadow-xl">
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            {errors.fornecedor && <ErrorMessage message={errors.fornecedor} />}
          </div>
